...
Public Class HomeForm
    ...
    Public AdminId As Integer = LoginForm.UserId
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Try
            Using conn As New SQLiteConnection("Data Source=dbhotel.db;Version=3;")
                conn.Open()
                Dim sql = "SELECT * FROM tbPelanggan WHERE Nama LIKE @Nama"
                Using cmd As New SQLiteCommand(sql, conn)
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        AdminId = -1
        LoginForm.UserId = -1
        MsgBox("Anda telah logout.", MsgBoxStyle.Information)
        Me.Hide()
        menuUser.Show()
    End Sub
End Class
